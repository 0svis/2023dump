...
namespace L2
{
    ...
    internal class Car
    {
        ...
        /// </summary>
        /// <returns>Returns formatted string that will be used for CSV
        /// format</returns>
        public string ToStringCSV()
        {
            string line;
            line = string.Format("{0},{1},{2}", model, passengerAmount, 
                fuelConsumption);
            return line;
        }
        /// <summary>
        /// Compares cars based on passenger amount and if passenger
        /// amount is equal then it is compared by fuel consumption
        /// </summary>
        /// <param name="Two">Another car</param>
        /// <returns>Comparison value</returns>
        public bool Compare (Car Two)
        {
            return this.passengerAmount > Two.passengerAmount || 
                (this.passengerAmount == Two.passengerAmount && 
                this.fuelConsumption > Two.fuelConsumption);
        }
    }
}