...
namespace L2
{
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Menu section "Input" button, programmed actions
        /// </summary>
        ...
        private void input_Click(object sender, EventArgs e)
        {
            ...
            input.Enabled = false;
            print.Enabled = true;
            label1.Text = "Data file added successfuly";
        }
        /// <summary>
        /// Menu section "Print" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void print_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                {
                    using (var fr2 = 
                        new StreamWriter(fr, Encoding.GetEncoding(1257)))
                    {
                ...
                label1.Text = "Print file added successfuly";
            }
        }
        /// <summary>
        /// Menu section "CSV" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            if (result == DialogResult.OK)
            {
                ...
                using (var fr = File.Open(CFr, FileMode.Append))
                {
                    using (var fr2 = 
                        new StreamWriter(fr, Encoding.GetEncoding(1257)))
                    {
                        fr2.Write("Companies names: {0},{1},{2}",
                            oneCompanyName, twoCompanyName, threeCompanyName);
                    }
                }
                DataToStringCSV(CFr, carsBelowFuelCons, "List");
                csv.Enabled = false;
                label1.Text = "CSV file added successfuly";
            }
        }
        /// <summary>
        /// Menu section "Find" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void find_Click(object sender, EventArgs e)
        {
            ...
            int twoCompanyMostPass = MostPassengers(twoCompany);
                ...
                resultPrint.LoadFile(CFr, RichTextBoxStreamType.PlainText);
            label1.Text = "Action ''Find'' was done successfuly";
        }
        /// <summary>
        /// Menu section "Sort" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void sort_Click(object sender, EventArgs e)
        {
            ...
            resultPrint.LoadFile(CFr, RichTextBoxStreamType.PlainText);
            label1.Text = "Action ''Sort'' was done successfuly";
        }
        /// <summary>
        /// Menu section "Filter fuel consumption" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void filterFuelConsumptionToolStripMenuItem_Click
            (object sender, EventArgs e)
        {
            List<Car> temp = NewArray(oneCompany, twoCompany);
            carsBelowFuelCons = Removal(temp);
            DataToString(CFr, carsBelowFuelCons, 
                "\nCars whose fuel consumption is " +
                "lower than biggest car overall");
            resultPrint.LoadFile(CFr, RichTextBoxStreamType.PlainText);
            label1.Text = "Action ''Filter fuel consumption''" +
                " was done successfuly";
        }
        /// <summary>
        /// Menu section "Close" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// "Find" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void findButton_Click(object sender, EventArgs e)
        {
            ...
            DataToString(CFr, carsBelowFuelCons, "Cars that doesn't " +
                "exceed entered fuel consumption");
            resultPrint.LoadFile(CFr, RichTextBoxStreamType.PlainText);
            label1.Text = "Button ''Find'' was pressed successfuly";
        }
        /// <summary>
        /// Menu section "Clear Text" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            resultPrint.Clear();
            label1.Text = "Action ''Clear'' was done successfuly";
        }
        /// <summary>
        /// Menu section "Additional Data" button, programmed actions
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void additionalData_Click(object sender, EventArgs e)
        {
            ...
            DataToString(CFr, carsBelowFuelCons, 
                "Sorted results list + third company added to sorted list");
            resultPrint.LoadFile(CFr, RichTextBoxStreamType.PlainText);
            label1.Text = "Action ''Additional Data'' was done successfuly";
        }
        //-----------------------------------------------------
        //User methods
        //-----------------------------------------------------
        /// <summary>
        /// Read all data from a file to list
        /// </summary>
        /// <param name="file">File name</param>
        /// <param name="companyName">Name of the company</param>
        /// <returns>List with company cars data</returns>
        ...
        /// <summary>
        /// Prints the container data to desired results file in tabular form
        /// </summary>
        /// <param name="fv">File name</param>
        /// <param name="companyCars">Company's cars container</param>
        /// <param name="heading">Text above the table</param>
    ...
    string heading)
        ...
        /// <summary>
        /// Finds most economical car of the company, index
        /// </summary>
        /// <param name="companyCars">Company's cars container</param>
        /// <returns>Company's most economical car index</returns>
        ...
        /// <summary>
        /// Finds company's car that capable to carry most passangers
        /// </summary>
        /// <param name="companyCars">Company's cars container</param>
        /// <returns>Company's car that capable to carry 
        /// most passangers</returns>
        ...
        /// <summary>
        /// Creates new array with two companies data
        /// </summary>
        /// <param name="oneCompany">First company cars container</param>
        /// <param name="twoCompany">Second company cars container</param>
        /// <returns>New array with two companies data</returns>
        ...
        /// <summary>
        /// Removes cars that fuel consumption doesn't 
        /// exceed most passenger car of both companys
        /// </summary>
        /// <param name="newArray">Array with two companies data</param>
        ...
        /// Sort modified list
        /// </summary>
        /// <param name="carsBelowFuelConsumption">Companies list</param>
        static void Sort_List(List<Car> carsBelowFuelConsumption) 
        {
            for (int write = 0; write < carsBelowFuelConsumption.Count; 
                write++)
            {
                for (int sort = 0; sort < carsBelowFuelConsumption.Count; 
                    sort++)
                {
                    if (carsBelowFuelConsumption[write].Compare
                        (carsBelowFuelConsumption[sort]))
                    {
                        Car temp = carsBelowFuelConsumption[write];
                        carsBelowFuelConsumption[write] =
                            carsBelowFuelConsumption[sort];
        ...
        /// <summary>
        /// Remove cars that exceed user's entered fuel consumption
        /// </summary>
        /// <param name="carsBelowFuelConsumption">Cars list</param>
        /// <param name="enteredFuel">Entered fuel consumption</param>
        static void RemoveSpecific(List<Car> carsBelowFuelConsumption, 
            double enteredFuel)
        {
        ...
        /// <summary>
        /// Adds additional company's car list to exsisting list
        /// </summary>
        /// <param name="additionalCompany">Additional company's list</param>
        /// <param name="alreadyExisting">Already exsisting list</param>
        static void AdditionalCompany(List<Car> additionalCompany,
            List<Car>alreadyExisting)
        {
        ...
        /// <summary>
        /// Prints the container data to .csv file
        /// </summary>
        /// <param name="fv">File name</param>
        /// <param name="companyCars">Container of car objects</param>
        /// <param name="heading">String above the table</param>
